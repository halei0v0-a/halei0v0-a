...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://blog.halei0v0.ccwu.cc", // 请替换为你的站点URL，以斜杠结尾
...
// Pio 看板娘配置（基于 l2d-widget，支持 Cubism 2/3/4/5 模型）
export const pioConfig: import("./types/config").PioConfig = {
	enable: true, // 启用看板娘
	models: ["/pio/models/lanlong/lanlong.model3.json"], // 蓝龙模型（Cubism 3/4 格式）
	position: "left", // 模型位置
	width: 280, // 默认宽度
	height: 250, // 默认高度
	...
	dialog: {
		welcome: "欢迎来到我的博客！我是守护这里的蓝龙～", // 欢迎词
		touch: [
			"哎呀，别乱摸我的鳞片啦！",
			"再摸我可要喷火警告了哦！",
			"龙族也是有尊严的！",
		...
		home: "需要我载你一程回首页吗？随时可以哦～", // 首页提示
		skin: ["我最近换了一身新的龙鳞，好看吗？", "龙鳞在阳光下闪闪发光呢～"], // 换装提示
		close: "无论什么时候来，我都会在这里等你～", // 关闭提示
		link: "https://github.com/halei0v0", // 关于链接
	},
};
...
export const umamiConfig = {
	...
	apiKey:
		import.meta.env.UMAMI_API_KEY || "api_FcFZNJMiv65r5nMEygtYupbR1t9LVy7X", // API密钥优先从环境变量读取，否则使用配置文件中的值
