...
export const devicesData: DeviceCategory = {
	"电脑配件": [
		...
		},
		{
			...
			"specs": "CPU",
			"description": "华硕 GT 502 TUF Gaming机箱",
		...
		},
		{
			...
			"specs": "CPU",
			"description": "intel 13代 i5 13600KF",
		...
		},
		{
			...
			"specs": "内存",
			"description": "Kingston FURY™ Beast DDR5 6000MT/s 内存为下一代游戏平台提供了卓越的速度、容量和可靠性。通过增强功能，如片内 ECC 以提升稳定性，以及双 32 位子通道以提高效率，让您的机器性能更上一层楼。Kingston FURY Beast DDR5 支持 Intel® XMP 3.0 和 AMD EXPO™ 的超频规格，并提供可自定义的速度和时序配置文件，助您充分挖掘游戏体验、实现 4K+ 高清直播，或加速动画和 3D 渲染项目。",
		...
		},
		{
			...
			"specs": "硬盘",
			"description": "PCIe 4.0 NVMe M.2 7,000MB/秒读取速度、3,900MB/秒写入速度",
		...
		},
		{
			...
			"specs": "水冷",
			"description": "CPU散热器，一体式水冷散热器散热方式\t水冷|适用范围\tIntel：LGA 115X/1200/1700/1851/2011/2066产品尺寸\t397×120×27mm其它特点\t屏幕参数：2.4寸IPS显示屏，320*240分辨率，450nits峰值亮度 ，24BIT真彩色风扇数量\t1个风扇尺寸\t120×120×25mm轴承类型\t流体动态轴承（FDB）最高转数\t2000RPM转数描述\t2000±10%RPM最大风量\t70.84CFM风压\t2.63mmaq噪音\t≤29.8dB端子接口\t4PIN PWM+3PIN ARGB水冷排类型\t360mm冷排冷头尺寸\t69.2×69.2×60mm",
