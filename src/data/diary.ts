...
const diaryData: DiaryItem[] = [
	...
	{
		"content": "我还真就是那个玩team端三角洲的人，虽然账号数据和wegame不通，但我毕竟不玩手机端不是吗【不卖号就不存在充钱低人一等的说法】，开心就好，要让我再转wegame也不现实了。玩steam端也挺好的，三家篓子能出个数据互通的功能就好了，用惯了steam别的啥都不习惯。",
		"date": "2026-09-12",
		"id": 11,
	}
];
